    ...
    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('reservations.store') }}" class="space-y-6">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="submit" class="inline-flex items-center justify-center rounded-2xl bg-brand-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-brand-700">Créer la réservation</button>
            </div>
        </form>
    </div>
</div>
