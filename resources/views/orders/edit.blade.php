...
<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <p class="text-sm font-semibold uppercase tracking-[0.3em] text-brand-600">Modifier commande</p>
            <h2 class="text-3xl font-semibold text-slate-900">Modifier la commande</h2>
            <p class="mt-2 text-sm text-slate-500">Mettez à jour les détails de la commande.</p>
        </div>
